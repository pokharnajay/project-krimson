...
export default function ChatSidebar({ isOpen, onToggle, currentChatId }) {
  ...
  return (
    <>
      ...
      {!isOpen && (
        <div className="fixed top-0 left-0 h-full w-12 bg-white border-r border-claude-border z-50 flex flex-col items-center pt-4">
          <button
      ...
      {isOpen && (
        <div className="fixed top-0 left-0 h-full bg-white border-r border-claude-border z-50 w-80 flex flex-col">
